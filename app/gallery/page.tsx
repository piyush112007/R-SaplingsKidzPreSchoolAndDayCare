...
const GALLERY_ITEMS = [
  {
    ...
    category: "Art & Craft",
    description: "Finger painting and exploring water colors on recycled paper.",
    emoji: "🎨",
    bgColor: "#ffebee",
    borderColor: "#e91e63",
  ...
  },
  {
    ...
    description: "Chasing butterflies and exploring garden plants in our backyard.",
    emoji: "🦋",
    bgColor: "#e8f5e9",
    borderColor: "#4caf50",
  ...
  },
  {
    ...
    category: "Learning",
    description: "Building cardboard rockets and learning about the moon and stars.",
    emoji: "🚀",
    bgColor: "#e3f2fd",
    borderColor: "#2196f3",
  ...
  },
  {
    ...
    category: "Art & Craft",
    description: "Bringing favorite storybook characters to life with clay modeling.",
    emoji: "🧸",
    bgColor: "#fff3e0",
    borderColor: "#ff9800",
  ...
  },
  {
    ...
    category: "Active Play",
    description: "Building castles and learning motor skills through tactile play.",
    emoji: "🏖️",
    bgColor: "#fffde7",
    borderColor: "#fbc02d",
      ...
      <main style={{ minHeight: "80vh", backgroundColor: "#fff" }}>
        ...
        <section style={{
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: "800px", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "3.5rem", color: "#f57f17", marginTop: "1.5rem", marginBottom: "1.5rem", fontFamily: "var(--font-headings)" }}>
              Life at R'saplings
            </h1>
            <p style={{ fontSize: "1.2rem", color: "#f57f17", lineHeight: "1.6", fontWeight: "500" }}>
              Explore the colorful tapestry of daily adventures, creative experiments, and playful learning steps
              our little ones take here every single day.
            </p>
          </div>
            ...
            {categories.map(cat => (
              <button
                ...
                style={{
                  ...
                  boxShadow: selectedCategory === cat ? "0 4px 10px rgba(255, 107, 43, 0.3)" : "none"
                }}
              >
                {cat}
              </button>
