...
export const metadata = {
  ...
  description: "Read heartfelt reviews and testimonials from our community of parents.",
};
...
export default function TestimonialsPage() {
  return (
    <>
      ...
      <main style={{ minHeight: "80vh", backgroundColor: "#fafafa" }}>
        {/* Testimonials Hero */}
        <section style={{
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: "800px", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "3.5rem", color: "#880e4f", marginTop: "1.5rem", marginBottom: "1.5rem", fontFamily: "var(--font-headings)" }}>
              Parents Echoes
            </h1>
            <p style={{ fontSize: "1.2rem", color: "#c2185b", lineHeight: "1.6", fontWeight: "500" }}>
              Nothing brings us more joy than the words of love, gratitude, and feedback shared by our parents.
              Here is what they say about their child&apos;s journey at R&apos; Saplings.
            </p>
          </div>

          {/* Cloud SVG separator */}
          <div style={{ position: "absolute", bottom: 0, left: 0, width: "100%", lineHeight: 0 }}>
            <svg viewBox="0 0 1440 100" style={{ width: "100%", height: "60px", fill: "#fafafa" }}>
          ...
          <div style={{
            ...
            {DETAILED_TESTIMONIALS.map((t, idx) => (
              ...
              >
                ...
                <div style={{ zIndex: 1 }}>
                  {/* Stars */}
                  <div style={{ color: "#ffb300", fontSize: "1.2rem", marginBottom: "15px" }}>
                    {"★".repeat(t.stars)}
                  </div>
